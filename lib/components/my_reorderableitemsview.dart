...
///
class MyReorderableItemsView extends StatefulWidget {
  /// Creates a reorderable list.
  MyReorderableItemsView({
    Key? key,
    this.header,
  ...
  /// underlying list.
  ///
  /// This [MyReorderableItemsView] calls [onReorder] after a list child is dropped
  /// into a new position.
  ...
  @override
  _MyReorderableItemsViewState createState() => _MyReorderableItemsViewState();
}
...
class _MyReorderableItemsViewState extends State<MyReorderableItemsView> {
  ...
  final GlobalKey _overlayKey =
      GlobalKey(debugLabel: '$MyReorderableItemsView overlay key');
